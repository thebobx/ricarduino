...
public class RicarduinoTestContainer extends TestContainer {

    public RicarduinoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "net/tillard/ricarduino/app.properties",
    ...
    public static class Common extends RicarduinoTestContainer {

        public static final RicarduinoTestContainer.Common INSTANCE = new RicarduinoTestContainer.Common();
